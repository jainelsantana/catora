  ...
  return (
    <>
      ...
      <main className="container-page py-8">
        <Link href="/#produtos" className="mb-6 inline-flex items-center gap-2 text-sm font-bold text-graphite transition hover:text-lagoon">
          <ArrowLeft size={18} />
        ...
        <section className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div className="flex flex-col justify-center">
            ...
            <h1 className="text-4xl font-black leading-tight text-ink">{produto.nome}</h1>
            <p className="mt-4 text-lg font-black text-lagoon">{formatCurrency(produto.preco)}</p>
            <p className="mt-5 text-base leading-7 text-slate-600">{produto.descricaoCompleta}</p>
